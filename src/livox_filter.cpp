...
livox_filter::livox_filter() {
    ...
    livox_lidar_pub = nh.advertise<livox_ros_driver::CustomMsg>("/filtered_livox_lidar", 1000);
    livox_imu_pub = nh.advertise<sensor_msgs::Imu>("/filtered_livox_imu", 1000);
}

livox_filter::~livox_filter(){}

void livox_filter::lidar_callback(const livox_ros_driver::CustomMsg::ConstPtr& msg){
    livox_ros_driver::CustomMsg filtered_msg;
